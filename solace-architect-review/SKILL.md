...
## Step 4: Write findings and complete
...
```bash
ACTIVE=$(cat projects/.active)
cat > "projects/$ACTIVE/artifacts/reviews/architect-review.md" << 'EOF'
<paste the structured review findings>
EOF
```

Update decisions.yaml with any new decisions from the review.
