...
Based on discovery, here's the recommended skill sequence:
  ...
  17. → Diagram generation (/solace-diagrams)
  18. → Executive summary (/solace-executive)
...
2. Present a summary of the engagement:
   - Skills completed
...
3. Update the plan's progress to complete.

4. The finalize sequence is: `/solace-blueprint` (technical deliverable) ->
