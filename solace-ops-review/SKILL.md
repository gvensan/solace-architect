...
## Step 5: Write findings and complete

Structure findings by operational risk:

- **P1 — Production risk:** Missing monitoring, unhandled failure modes, no runbook
  for critical paths.
- **P2 — Scaling risk:** Capacity limits that will be hit within the stated growth
  trajectory.
- **P3 — Operational debt:** Missing automation, manual processes that should be
  automated, incomplete documentation.
...
<paste the structured review findings>
EOF
```
