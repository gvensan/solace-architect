...
- **Confirmed** — things that are well-designed and should be preserved.
  These are positive confirmations, not issues. Confirmed findings are NOT
  passed to the FINDING_RESOLUTION Apply/Defer/Discuss queue — they go to
...
cat > "projects/$ACTIVE/artifacts/10-reviews/dev-review.md" << 'EOF'
